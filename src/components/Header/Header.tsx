    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-white'>
      <div className='container'>
        <div className='flex justify-end'>
          ...
          <Popover
            className='flex cursor-pointer items-center py-1 first-letter:ml-6 hover:text-gray-300'
            renderPopover={
              <div>
                <Link
                  to='/'
          ...
          >
            <div className='mr-2 h-6 w-6 flex-shrink-0'>
              <img
                ...
                alt='avatar'
                className='h-full w-full rounded-full rounded-full object-cover'
              />
            </div>
            <div>vuanhtuan</div>
          </Popover>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <form className='col-span-9'>
            <div className='flex rounded-sm bg-white p-1'>
              ...
              />
              <div className='button flex-shrink-0 rounded-sm bg-orange py-2 px-6 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='col-span-1 justify-self-end'>
            <Popover
              renderPopover={
                <div className='shawdow-md relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm'>
                  <div className='p-2'>
                    <div className='capitalize text-gray-400'>Sản phẩm mới</div>
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://cf.shopee.vn/file/sg-11134201-22120-40et9zykjmkv7f'
                            alt='img'
                        ...
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>
                            500pcs / 630pcs Ốc Bắt Sửa Chữa Điện Thoại, Máy Tính Bảng, Laptop, Máy Tính, Các Loại Máy
                            Móc Nhỏ M1.2 M1.4 M2 M2.5 M3.0
                          </div>
                          <div className='ml-2 flex-shrink-0'>
                            <span className='text-orange'>100.000đ</span>
                          </div>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
